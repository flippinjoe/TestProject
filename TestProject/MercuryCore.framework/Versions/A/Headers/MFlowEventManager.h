...
@property (nonatomic, retain) NSDateFormatter *aggKeyDateFormatter;
...
@property (nonatomic, retain) NSURL *currentSesssionObjectIDURL;
@property (nonatomic, retain) NSURL *currentLaunchObjectIDURL;
@property (nonatomic, retain) NSMutableDictionary *aggEventURICache;
